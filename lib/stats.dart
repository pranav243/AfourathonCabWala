      ...
      body: Center(
        child:
            Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
              ...
              children: [SizedBox(height:ScreenUtil().setHeight(44),width:ScreenUtil().setWidth(29),child: Image.asset("images/location.png")),Text(city, style:TextStyle(fontFamily: 'Poppins', fontSize: ScreenUtil().setSp(26),color: Color(0xFF09648C)))],),
          Row(
